...
<template>
  <span
    ref="el"
    data-dance-chip
    class="group/chip flex items-center cursor-grab rounded bg-dance px-2 py-1 text-xs font-medium leading-tight text-dance-foreground select-none glass glass-dance has-[[data-grip]:focus-visible]:ring-2 has-[[data-grip]:focus-visible]:ring-ring comfortable:px-3 comfortable:py-1.5 comfortable:text-sm"
