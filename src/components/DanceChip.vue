...
<template>
  <span
    ref="el"
    data-dance-chip
    class="group/chip flex min-w-0 items-center cursor-grab rounded bg-dance px-3 py-1.5 text-sm font-medium leading-tight text-dance-foreground select-none glass glass-dance has-[[data-grip]:focus-visible]:z-10 has-[[data-grip]:focus-visible]:ring-2 has-[[data-grip]:focus-visible]:ring-ring"
