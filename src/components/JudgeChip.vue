...
<template>
  <span
    ref="el"
    data-judge-chip
    class="group/chip flex min-w-0 items-center cursor-grab rounded bg-judge px-3 py-1.5 text-sm font-medium leading-tight text-judge-foreground select-none glass glass-judge has-[[data-grip]:focus-visible]:z-10 has-[[data-grip]:focus-visible]:ring-2 has-[[data-grip]:focus-visible]:ring-ring"
