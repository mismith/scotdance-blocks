...
<template>
  <span
    ref="el"
    data-group-chip
    class="group/chip flex min-w-0 items-center rounded-lg bg-group/10 px-3 py-1.5 text-sm font-medium leading-tight text-group-foreground/80 dark:text-group/80 select-none glass glass-group glass-draggable border-dashed! hover:bg-group/25 has-[[data-grip]:focus-visible]:z-10 has-[[data-grip]:focus-visible]:ring-2 has-[[data-grip]:focus-visible]:ring-ring"
